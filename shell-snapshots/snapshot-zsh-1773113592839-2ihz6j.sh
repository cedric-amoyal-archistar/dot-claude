...
if ! (unalias rg 2>/dev/null; command -v rg) >/dev/null 2>&1; then
  ...
  if [[ -n $ZSH_VERSION ]]; then
    ARGV0=rg /Users/cedricamoyal/.vscode/extensions/anthropic.claude-code-2.1.72-darwin-x64/resources/native-binary/claude "$@"
  elif [[ "$OSTYPE" == "msys" ]] || [[ "$OSTYPE" == "cygwin" ]] || [[ "$OSTYPE" == "win32" ]]; then
    ARGV0=rg /Users/cedricamoyal/.vscode/extensions/anthropic.claude-code-2.1.72-darwin-x64/resources/native-binary/claude "$@"
  elif [[ $BASHPID != $$ ]]; then
    exec -a rg /Users/cedricamoyal/.vscode/extensions/anthropic.claude-code-2.1.72-darwin-x64/resources/native-binary/claude "$@"
  else
    (exec -a rg /Users/cedricamoyal/.vscode/extensions/anthropic.claude-code-2.1.72-darwin-x64/resources/native-binary/claude "$@")
  fi
}
fi
export PATH=/Users/cedricamoyal/.local/bin\:/Users/cedricamoyal/.nvm/versions/node/v22.16.0/bin\:/usr/local/bin\:/usr/local/sbin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin\:/Library/Apple/usr/bin
